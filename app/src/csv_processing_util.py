...
def main():
    ...
    cv2.namedWindow('image_cells', cv2.WINDOW_NORMAL)
    cv2.imshow('image_cells', image_cells)
    ...
    # print('list_of_csv_1_cnt_data_dict=', list_of_csv_1_cnt_data_dict)
    # print('len(list_of_csv_1_cnt_data_dict)=', len(list_of_csv_1_cnt_data_dict))
    # print()

    list_of_GT_1_cnt_data_dict = get_list_of_cnt_data_dict(contours=contours_from_image_GROUND_TRUTH, color='G')
    # print('list_of_GT_1_cnt_data_dict=', list_of_GT_1_cnt_data_dict)
    # print('len(list_of_GT_1_cnt_data_dict)=', len(list_of_GT_1_cnt_data_dict))
    # print()
    ...
    # print('common_contours_list_of_dict_1=', common_contours_list_of_dict_1)
    # print('fail_GT_contours_list_of_dict_1=', fail_GT_contours_list_of_dict_1)
    # print('fail_csv_contours_list_of_dict_1=', fail_csv_contours_list_of_dict_1)
    ...
    print('Number_common_1/Number_GT_contours_1=', Number_common_1 / Number_GT_contours_1)

    # ----------------------------------DRAW_RESULTS--------------------------------------------
    draw_contours_on_image(contours=contours_from_file,
                           color='G',
                           image=image_cells,
    ...
    # print('calculate_area_of_contours(fail_GT_contours_list_of_dict_1)=', calculate_area_of_contours(fail_GT_contours_list_of_dict_1))
    # print('calculate_area_of_contours(fail_csv_contours_list_of_dict_1)=', calculate_area_of_contours(fail_csv_contours_list_of_dict_1))
    # print()
    print('S(common_1)/S(GT_1)=', S_common_1 / S_GT_1)
